...
//        String stringData = "Benjo Hernan Luna Milton Laura";
//
//        String[] data = stringData.split(" ");
//        for (String s : data) {
//            ListedItem = new ListedItem(s);
//
//        }
...
//
//
//        String stringData = "Benjo Hernan Luna Armando Milton Laura";
//
//        String[] data = stringData.split(" ");
//        for (String s : data) {
//            list.addItem(new Person(s));
//        }
//
//        list.printList();
//
//        ListedItem toRemove = list.getCurrentItem();
//        toRemove = toRemove.goNext();
//        System.out.println("Item to remove: " + toRemove);
//
//        list.removeItem(toRemove);
//        ListedItem root1 = list.getRoot();
//
//        list.goThrough(root1);

        System.out.println("Now with binary tree search:");
        BinaryTreeSearchClass list2 = new BinaryTreeSearchClass();

        String stringData2 = "Jorge Hernan Ana Lucia Cristina Jose";

        String[] data2 = stringData2.split(" ");
        for (String s : data2) {
            list2.addItem(new Person(s));
        }

        ListedItem root2 = list2.getRoot();

        System.out.println("Printing method 1 (without ArrayList): ");
        list2.goThrough(root2);

        System.out.println("Printing method 2 (with ArrayList): ");
        list2.goThrough(root2);

        System.out.println("Printing with traverse (TB's): ");
